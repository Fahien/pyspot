...
TEST_F( Python, instantiate_struct )
{
	...
	struct_test.Invoke( "create_details" );
}
...
{
	Module           struct_test{ "struct-test" };
	Wrapper<Details> one = struct_test.Invoke( "create_details" );
...
{
	Module           struct_test{ "struct-test" };
	Wrapper<Details> two = struct_test.Invoke( "send_details", { Wrapper<Details>{ Details{ 2 } } } );
...
{
	Module struct_test{ "struct-test" };
	Bool   result = struct_test.Invoke( "compare_details", { Wrapper<Details>{ Details{ 3 } } } );
	ASSERT_TRUE( result );
...
TEST_F( Python, reassign_struct )
{
	...
	Wrapper<Details> result = struct_test.Invoke( "change_details", { details } );
